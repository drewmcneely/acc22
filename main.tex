...
\title{\LARGE \bf
A Domain Specific Language for Filtering using Categorical Probability
}


\author{Drew McNeely \and Efstathios Bakolas% <-this % stops a space
\thanks{Drew McNeely (PhD student) and Efstathios Bakolas (Associate Professor) are with the Department of Aerospace Engineering, The University of Texas at Austin, Austin, Texas, 78712-1221, USA, Email:
...
Small paragraph: what's the problem

\subsection{Literature Review}

Bigger paragraph.
Find some relevant literature from controls community.
